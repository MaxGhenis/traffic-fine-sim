...
class WelfareOptimizer:
    ...
    def objective_function(self, params: np.ndarray) -> float:
        ...
        if self.fine_structure_class == FlatFine:
            ...
            raise ValueError(f"Unknown fine structure class: {self.fine_structure_class}")
    ...
    def compare_fine_structures(
        self,
        initial_tax_rate: float = 0.3
    ) -> Dict[str, Any]:
        """
        ...
        income_params, income_utility, income_history = income_optimizer.optimize(income_initial)
        ...
        results['welfare_pct_change'] = (income_utility - flat_utility) / flat_utility * 100
