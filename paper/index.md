# Optimal Income-Based Externality Pricing: Evidence from Traffic Fines
...
Our model is calibrated to Finland's day-fine system, which has operated since 1921 and provides the most comprehensive real-world implementation of income-based penalties. Using parameters from {cite}`kaila2024` and Finnish institutional data, we find that **the optimal fine is essentially flat** when labor supply responses are considered. Current Finnish policy sets fines at 1.67% of monthly income (1/60). Without considering labor supply responses, a pure deterrence model would suggest a steep gradient of approximately 2.5% of monthly income. However, when labor supply responses are incorporated using continuous optimization, the optimal income gradient falls to approximately zero—indicating that flat fines maximize welfare. Strikingly, the unconstrained optimum is actually *regressive* (−13.5% of income), suggesting pure efficiency favors lower fines for high earners because income-based fines compound existing tax distortions.
